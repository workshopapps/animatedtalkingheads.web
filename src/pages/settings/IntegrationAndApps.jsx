...
const IntegrationAndApps = () => {
    ...
    const handleClick = () => setErrorMessage('Could not connect app successfully. Try again')
    return (
        <section className="mt-6">
            ...
            <div className="flex gap-4 mt-6">
                ...
                <div>
                    <button onClick={handleClick} className="bg-[#2563EB] px-3 h-14 w-24 rounded-md text-white">Connect</button>
                    {errorMessage}
                </div>
