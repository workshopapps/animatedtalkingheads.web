...
const Communities = () => {
  ...
  const Container2 = ({children}) => {
    return (
      <div className={`${styles.background2} px-4 md:px-28`}>
        {children}
      </div>
    )
  }
    ...
    <Layout>
      <div>
        ...
        <Container>
          ...
          <section className={styles.story}>
            ...
            <div className='grid grid-cols-1 gap-x-10 md:grid-cols-2 md:gap-y-10 md:py-16 lg:py-6'>
              ...
              <div className='basis-3/5'>
                ...
                <p>
                  Led by a passionate, collaborative team with a strive for excellence, 
              ...
              <div className='basis-3/5'>
                ...
                <p>
                  Voxclips is committed to producing top-quality animated videos by incorporating an easy AI model that breathes life into your podcasts.
              ...
              <div className='basis-3/5'>
                ...
                <p>
                  Since 2022 Voxclips has been committed to creating 
          ...
          <div className='flex justify-end'>  <button className={styles.viewAll}>View All</button> </div>
        ...
        <Container>
          ...
          <div className='mt-6 flex justify-end'>  <button className={styles.viewAll}>View All</button> </div>        
