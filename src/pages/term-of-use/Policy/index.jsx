  ...
  const termsContent = [
    {
      ...
      content: (
        <p>
          <p className="inline">
            Welcome to Voxclips! These terms and conditions outline the rules and regulations for
            the use of Mechanic Team Clutch HNG9 Website, located at
          </p>
          ...
          continue to use Voxclips if you do not agree to take all of the terms and conditions
          stated on this page.
        </p>
      )
    },
    ...
    },
    {
      ...
      content: (
        <p>
          ...
          MechanicTeam Clutch HNG9 or its licensors, which retains all rights, titles and interests
          in and tosuch Materials and all intellectual property rights relating thereto, including
          ...
          <p>
            ...
            rightto make changes without prior notice,
          </p>
          <br />
          Other than as specifically set forth herein, no transfer or grant of any rights is made or
          isto be implied by any provision of these Terms. You agree not to infringe upon all
          theabove rights
        </p>
      )
    },
    {
      ...
      content: (
        <p>
          Unless otherwise stated, Mechanic Team Clutch HNG9 and/or its licensors own
          theintellectual property rights for all material on Voxclips. All intellectual property
          rights are reserved. You may access this from Voxclips for yourown personal use subject to
          ...
          <br />
          <br />
          To the extent permitted by applicable laws, Mechanic Team Clutch shall not be liable for
          the Comments or for any liability, damages or expenses caused and suffered becauseof any
          use of or posting of appearance of the Comments on this website.
          <br />
          <br />
          Mechanic Team Clutch HNG9 reserves the right to monitor all Comments and toremove any
          Comments, which can be considered inappropriate, offensive or causes abreach of these
          ...
          and authorize others to use, reproduce and edit any of your Commentsin all forms, formats
          or media.
        </p>
      )
    },
    ...
    },
    {
      ...
      content: (
        <p>
          ...
          ofcopyrighted works is a copyright infringement, and Mechanic team clutch HNG9
          willundertake appropriate steps against copyright offenders.
        </p>
      )
    },
    {
      ...
      content: (
        <p>
          ...
          andits products and/or services;
          <br />
          ...
          <br />
          (b) does not falsely imply sponsorship, endorsement or approval of the linking party
          andits products or services;
          <br />
          (c) fits within the context of the linking party’s site.
          <br />
          <br />
          If you are one of the organizations listed in paragraph 2 above and are interested in
          linking to our website, you must inform us by sending an e-mail to Mechanic TeamClutch
          HNG9.
          <br />
          <br />
          Please include your name, your organization name, and contact information as well asthe
          URL of your site, a list of any URLs from which you intend to link to our Website,and a
          list of the URLs on our site to which you would like to link. Wait 1-2 weeks for a
          response.
          <br />
          <br />
          ...
          <br />
          <br />
          No use of Mechanic Team Clutch's logo or other artwork will be allowed for linking absent
    ...
    },
    {
      ...
      content: (
        <p>
          ...
          <br />
          <br />
          We also reserve the right to amend these terms and conditions and it’s linking policy at
    ...
    },
    {
      ...
      content: (
        <p>
          ...
          <br />
          <br />
          We do not warrant that any content displayed or otherwise available through voxclips will
          be accurate, complete, reliable, current, uninterrupted or error-free, or that voxclipsis
