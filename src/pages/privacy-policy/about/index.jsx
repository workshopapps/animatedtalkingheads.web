    ...
    return (
      <Layout>
        <div>
          <Top />
          <MainCard>
            <Text label={"About privacy policy"} className="!font-medium mb-[32px] !text-[20px] lg:!text-[36px] text-pri" />
            <div className="p-[16px] lg:pt-[24px] lg:px-[32px] bg-white rounded-md rounded-br-none rounded-bl-none">
              ...
              <Text className={"!text-base lg:!text-2xl !font-normal  pb-[40px] lg:pb-[80px]"}>
                ...
                to our website with regards to the information that they share and/or collect in
