  ...
  return (
    <Layout>
      ...
      <main>
        ...
        <div className={backgroundStyles.top_bg}><h1>Background Library</h1></div>
        ...
        <div className={backgroundStyles.backgroundContainer}>
              ...
              BackgroundLayout.map(val => (
                <figure key={val.id} className={backgroundStyles.figure}>
                  ...
                  <figcaption className={backgroundStyles.figCaption}>
                    ...
                    <h4 className='mt-2 md:mt-0 mb-2.5 md:mb-6 font-semibold text-lg md:text-2xl text-[#292D32]'>{val.name}</h4>

                    <h5 className={`${backgroundStyles.location} mb-2.5 md:mb-6 text-2xl`}> <LocationIcon className='mr-3' /> {val.location}</h5>
          ...
          <button onClick={scrollToTop} className='m-7 md:m-24 text-sm md:text-base text-[#292D32]'>Back to Top</button>
