      ...
      <div className="about">
        <div className="about_child">
          ...
          <div className="about_hero">
            <div className="about_hero_image"></div>
            ...
            <div className="about_main_content">
              ...
              <div className="about_mission">
                <div className="about_mission_section1">
                  <h3>OUR MISSION</h3>
                  <p>
                    Voxclips is the product of an ideation-to-implementation project that was
                    created to provide a solution for podcasters who struggle to make any waves
              ...
              <div className="about_values">
                ...
                <div className="values_grid_section">
                  <div className="values_grid">
                    ...
                    <h3>C - Concern</h3>
                    <p>
                      Concern for podcasters and creating innovation to enable more creatives to
                      grow; this drives us to continually improve our product.
                    </p>
                  </div>
                ...
                <div className="about_story_section">
                  ...
                  <div className="story_grid">
                    <h5>
                      ...
                      itch-on-the-back problem for creatives with great content who struggle to
                      thrive in the podcast industry.
                    </h5>
                    <h5>
                      {' '}
              ...
              <div className="about_team">
                <div className="about_team_section1">
                  ...
                  <div className="team_grid">
                    <h5>
                      At Voxclip we value trust, teamwork, and bringing engament and visibilty to
                      help podcasters create visual content out of their audio recordings.
                    </h5>
                  </div>
                </div>
