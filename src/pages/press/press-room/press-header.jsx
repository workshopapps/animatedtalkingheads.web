        ...
        <div className={styles.overlay}>
          <div className={styles.overlay2}>
            ...
            <div className={styles.container}>
              ...
              <p>
                Voxclips is a unique web based site which helps Podcasters to enhance their recorded
                audio series with 2D talking head characters to be engaging, interesting and time
                spending.
              </p>
