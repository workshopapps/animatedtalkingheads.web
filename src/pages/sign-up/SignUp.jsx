...
const SignUpSection = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    axios
      .post('https://api.voxclips.hng.tech/api/v1/auth/signup', formData)
      .then((res) => {
  ...
  return (
    <div className="sign-up">
        ...
        <div className="render-progress-container">
          <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" fill="none">
            <path
              ...
              strokeWidth="1.5"
              d="M19 34.833c8.708 0 15.833-7.125 15.833-15.834 0-8.708-7.125-15.833-15.833-15.833S3.167 10.291 3.167 18.999c0 8.709 7.125 15.834 15.833 15.834ZM14.52 23.481l8.961-8.962M23.481 23.481l-8.962-8.962"
            />
          </svg>
      ...
      <form className="form" onSubmit={handleSubmit}>
        ...
        <button style={{ marginBottom: '2rem' }} className="sign-up-btn">
          Sign Up
        </button>
      </form>
