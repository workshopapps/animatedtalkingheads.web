      ...
      <motion.div
        ...
        <div className={`${styles.dropdown_menu} ${open ? 'active' : 'inactive'}`} >
          ...
          <ul>
            ...
            <DropdownItem to={routes.settings} hide={hide} img={Upload} text={"My uploads"} />
            <DropdownItem to={routes.settings} hide={hide} img={Podcast} text={"My video podcasts"} />
            ...
            <DropdownItem to={"#"} hide={hide} onClick={handleSignOut} img={Logout} text={"Sign out"} />
          </ul>
        </div>
      </motion.div>
    </div>
